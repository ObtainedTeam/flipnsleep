  ...
  return (
    <div>
      <section style={{ textAlign: 'center', padding: isMobile ? '36px 20px 10px' : '54px 40px 16px' }}>
        ...
        <h1 style={{ fontFamily: FONT_DISPLAY, fontSize: isMobile ? 30 : 40, color: c.navy, margin: '8px 0 10px' }}>Pick your bundle</h1>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 22, maxWidth: 860, margin: '26px auto 0', padding: '0 20px' }}>
        {BUNDLES.map(b => {
